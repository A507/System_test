...
<script type="text/javascript">
    $(function(){
        ...
        $(".xiangqing").mouseout(function(){
            $(this).css("background-color","#29ace2");
        });
        $(".xiangqing").mouseenter(function(){
            $(this).css("background-color","#478db1");
        });
        $("#div_zhuxiao").mouseout(function(){
            $(this).css("background-color","#29ace2");
        });
        $("#div_zhuxiao").mouseenter(function(){
            $(this).css("background-color","#478db1");
        });


        //搜索
        $("#guanli_sousuo_").click(function(){
            if($("input[name='guanli']").val()==""){
                alert('搜索不能为空');
            }else{
                location.href="?search="+$("input[name='guanli']").val();
            }
        });
...
<div id="div_guanli_header">
    ...
    <div class="guanli_header"  style="background: white;color: dimgray;">身份管理</div>
    <div class="guanli_header">权限管理</div>
</div>
<div id="guanl_sousuo_content">
    <div id="guanli_sousuo_"></div>
    <div input_content1>
        <input type="text" name="guanli" value="姓名" id="input_guanli"/>
    </div>
</div>
<% for(int i=0;i<10;i++){
%>
<div class="div_content">
    <div class="div_head">
        ...
        <div class="shangchuanzhe1">id:<%out.print(ID[i]);%></div>
        <div class="shangchuanzhe1">复议数:0</div>
        <div class="shangchuanzhe1">反对数:100</div>
        <div class="biaoti">这个是标题</div>
        <a href="../guanli/guanlixiangqing.jsp?id=<%out.print(ID[i]);%> ">
        <div id="x1" class="xiangqing">修改权限</div>
        </a>
    </div>
</div>
<% }%>
