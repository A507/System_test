...
public class javabean {
   ...
   /* class yonghu{
      ...
      public void SETquanxian(int id,String quanxian) {  //给权限的函数

          try {

              String sql = "UPDATE quanxian SET quanxian=? WHERE id=? ";
              preparedStatement = con.prepareStatement(sql);
              preparedStatement.setString(1, quanxian);
      ...
      public String GETquanxian(int id){
        String quanxian;
          try {
              preparedStatement=con.prepareStatement("SELECT quanxian FROM quanxian WHERE id=?");
      ...
      public void getID(){
          ...
          try {
              ...
              resultSet=st.executeQuery("SELECT id FROM quanxian"); //执行SQL,取得结果
