...
<script type="text/javascript">
    $(function(){
        ...
        $("#quanxianguanli").click(function () {
            location.href="../guanli/quanxianguanli.jsp";
        });
    });
</script>
<div id="div_header">
...
<div id="div_guanli_header">
    ...
    <div class="guanli_header" id="quanxianguanli" style="background: white;color: dimgray;">权限管理</div>
</div>
...
<div class="div_content">
    <div class="div_head">
        ...
        <a href="../guanli/chakan.jsp?id=<%out.print(ID[i]);%> ">
        <div id="x1" class="xiangqing">查看</div>
        </a>
            <div id="x1" class="xiangqing">同意</div>
            <div id="x1" class="xiangqing">拒绝</div>
